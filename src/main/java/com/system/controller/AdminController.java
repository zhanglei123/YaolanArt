...
public class AdminController {
    ...
    public String addStudent(StudentCustom studentCustom, Model model) throws Exception {
        ...
        //添加成功后，也添加到登录表
        User user = new User();
        user.setUsername(studentCustom.getUserid().toString());
    ...
    private String removeStudent(Integer id) throws Exception {
        ...
        userService.removeByName(id.toString());
    ...
    public String addTeacher(TeacherCustom teacherCustom, Model model) throws Exception {
        ...
        //添加成功后，也添加到登录表
        User user = new User();
        user.setUsername(teacherCustom.getUserid().toString());
        user.setPassword("123");
        user.setRole(1);
        userService.save(user);
    ...
    public String userPasswordRest(User user) throws Exception {
        ...
        if (u != null) {
            ...
            userService.updateByName(user.getUsername(), u);
        } else {
